...
[state ~, Error, y_0 ,delta_y_0,error_0,A_0, del_ADR] = doppler_shift_positioning_robust_gps(shift, pos, lambda, current_time, eph, svids);
vpa(state)
...
hold on
geoplot([pos_true(1,1);pos_true(1,1)],[pos_true(1,2);pos_true(1,2)],'b-*')
