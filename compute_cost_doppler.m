...
for i=1:length(shift)
    ...
    del_ADR(i) = acculumulated_delta_range_derivative(rec_pos, c_rec_clock_bias,elapsedtime, rec_vel, c_rec_clock_bias_rate, pos(i,:)',lambda,ephemeris(i,1), JD_prop_to);
    R(i,i) = (0.01)^2;
